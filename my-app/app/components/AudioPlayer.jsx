...
export default function AudioPlayer({ title, manifestUrl, onClose }) {
  ...
  useEffect(() => {
    ...
    if (audio) {
      ...
      audio.addEventListener('progress', onProgress); // Listen for progress events
    ...
    const handleVolumeChange = (e) => {
      ...
      const handlePlaybackRateChange = (rate) => {
        ...
        return (
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-black bg-opacity-90 text-white p-2 shadow-lg z-50 mb-4">
