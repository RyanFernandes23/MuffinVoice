...
const plans = [
  ...
  },
  {
    ...
    color: "amber",
    popular: true,
    features: ["150MB max upload", "400K tokens/month", "All voices", "Priority support", "API access"],
  },
  {
    id: "professional",
    name: "Professional",
    ...
    tokens: "1.6M",
    color: "purple",
    features: ["200MB max upload", "1.6M tokens/month", "All voices", "24/7 support", "API access", "Custom integrations"],
  },
];
